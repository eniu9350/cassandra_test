...
all:
	gcc `pkg-config --cflags dbus-glib-1` \
			...
			../../../install/apache-cassandra-1.0.7/interface/gen-c_glib/cassandra_types.c ../../../install/apache-cassandra-1.0.7/interface/gen-c_glib/cassandra.c test.c -o testcass\
